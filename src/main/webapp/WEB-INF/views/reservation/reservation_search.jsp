        ...
        <div class="search_res">
          <form action="resv_find.do" method="get">
            ...
            <div class="select">
              ...
              <input class="res_name" type="text" id="mat_name" name="mat_name" value="${mat_name }">
            </div>
            <div class="select">
              <label for="mat_loca">하위주소</label>
              <input class="addr" type="text" id="mat_loca" name="mat_loca" value="${mat_loca }">
            </div>
            <script type="text/javascript">
            $('#foodcode option[value=${foodcode}]').prop('selected', 'selected').change();
            $('#themacode option[value=${themacode}]').prop('selected', 'selected').change();
            $('#locationcode option[value=${locationcode}]').prop('selected', 'selected').change();
	...
	function goPage(pages) {
		...
		if(pages ==0){
			...
			location.href="resv_find.do?"+
				"foodcode="+ document.getElementById("foodcode").value+
				"&themacode="+  document.getElementById("themacode").value+
				"&locationcode="+  document.getElementById("locationcode").value+
				"&mat_name="+  document.getElementById("mat_name").value+
				"&mat_loca="+  document.getElementById("mat_loca").value+
				"&pages="+ pages;
		}
	  }
